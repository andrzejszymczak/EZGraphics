...
public:
  ...
  virtual void initializeGL()
  {
    ...
    pgmGouraud = createProgram(
			       ShaderFile(Vert,"simple-viewer-shaders/vtxGouraud.glsl"),
			       ShaderFile(Frag,"simple-viewer-shaders/frgGouraud.glsl")
			       );
    cout << "Creating Phong program..." << endl;
    pgmPhong = createProgram(
			     ShaderFile(Vert,"simple-viewer-shaders/vtxPhong.glsl"),
			     ShaderFile(Frag,"simple-viewer-shaders/frgPhong.glsl")
			     );
